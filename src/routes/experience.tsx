...
const items = [
  ...
  },
  {
    ...
    body: "Currently pursuing a Bachelor's degree in Computer Science and Engineering (CGPA 8.03 - Semester 6). Studying data structures, systems engineering, databases, and full-stack development methodologies.",
